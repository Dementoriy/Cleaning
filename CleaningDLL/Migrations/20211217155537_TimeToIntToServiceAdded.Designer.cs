...
namespace CleaningDLL.Migrations
{
    ...
    [Migration("20211217155537_TimeToIntToServiceAdded")]
    partial class TimeToIntToServiceAdded
    {
            ...
            modelBuilder.Entity("CleaningDLL.ProvidedService", b =>
                {
                    ...
                    b.HasOne("CleaningDLL.ReferenceUnitsOfMeasurement", "ReferenceUnitsOfMeasurement")
                        .WithMany()
